const en = {
  ...
  'settings.behavior.monitorInterval.duration.seconds': '{seconds} seconds',
  ...
  'settings.behavior.navStyle.options.side': 'Side',
  'settings.behavior.navStyle.options.floating': 'Floating',
  ...
  'settings.behavior.navPosition.options.top': 'Top',
  ...
  'settings.start.actionOnClose.options.quit': 'Quit the app',
  'settings.start.actionOnClose.options.minimize': 'Minimize',
  'settings.start.windowMode.options.full': 'Full screen',
  'settings.start.windowMode.options.custom': 'Custom',
